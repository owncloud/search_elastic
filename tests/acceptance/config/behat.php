...
return (new Config())
	->withProfile(
		(new Profile(
			...
			->withSuite(
				(new Suite('webUISearchElastic'))
					->addContext('SearchElasticContext')
					->addContext(
						'FeatureContext',
						$featureContextArgs
					)
					->addContext('WebUIElasticSearchContext')
					->addContext('WebUIFilesContext')
					->addContext('WebUIGeneralContext')
					->addContext('WebUILoginContext')
					->addContext('WebUISearchContext')
					->withPaths('%paths.base%/../features/webUISearchElastic')
			)
			->withSuite(
				(new Suite('apiLimitSearches'))
					->addContext('SearchElasticContext')
					->addContext(
						'FeatureContext',
						$featureContextArgs
					...
					->withPaths('%paths.base%/../features/apiLimitSearches')
			)
			->withSuite(
				(new Suite('apiSearchElastic'))
					->addContext('SearchElasticContext')
					->addContext(
						'FeatureContext',
						$featureContextArgs
					...
					->addContext('SearchContext')
					->withPaths('%paths.base%/../features/apiSearchElastic')
			)
	);
